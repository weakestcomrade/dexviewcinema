...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyber-dark-900 via-cyber-dark-800 to-cyber-dark-900 p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-white via-brand-red-200 to-white bg-clip-text text-transparent">
              Admin Dashboard
            </h1>
            <p className="text-cyber-slate-300 mt-2">
              Welcome back, {session.user?.email}! Manage your cinema events and bookings
            </p>
          </div>
          <Button
            onClick={handleSignOut}
            variant="outline"
            className="bg-glass-white border-white/20 text-white hover:bg-red-500/20 hover:border-red-500/50"
          >
