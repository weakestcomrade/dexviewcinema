    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: "Your admin password has been changed and is now active.",
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  {passwordChangeSuccess && (
                    <div className="bg-green-900/20 border border-green-500/30 rounded-2xl p-4 mb-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <p className="text-green-400 font-medium">Password successfully updated!</p>
                      </div>
                    </div>
                  )}
